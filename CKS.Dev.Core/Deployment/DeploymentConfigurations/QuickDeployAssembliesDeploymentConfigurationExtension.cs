...
namespace CKS.Dev.VisualStudio.SharePoint.Deployment.DeploymentConfigurations
{
  ...
  internal class QuickDeployAssembliesDeploymentConfigurationExtension : ISharePointProjectExtension
  {
    ...
    private void ProjectInitialized(object sender, SharePointProjectEventArgs e)
    {
      ...
      if (!e.Project.DeploymentConfigurations.ContainsKey(CKSProperties.QuickDeployAssembliesDeploymentConfigurationExtension_Name))
      {
        ...
        IDeploymentConfiguration configuration = e.Project.DeploymentConfigurations.Add(
            CKSProperties.QuickDeployAssembliesDeploymentConfigurationExtension_Name, deploymentSteps, retractionSteps);
        configuration.Description = CKSProperties.QuickDeployAssembliesDeploymentConfigurationExtension_Description;
      }
    }
  }
}
